...
/**
 * Admin bootstrap — loads config, session, autoload, router.
 */
...
$router = new Router();
require CMS_ROOT . '/routes/admin.php';

$method = $_SERVER['REQUEST_METHOD'] ?? 'GET';
$uri = $_SERVER['REQUEST_URI'] ?? '/';

// Strip query string and admin base path (when installed in a subdirectory)
